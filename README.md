...
|---|---|---|
| [INTEGER_LLM](INTEGER_LLM/README/README.md) | bit-exakte Ganzzahl-Inferenz (Rust + Python) | Kernthese auf 0,5B empirisch bestätigt (+2,3 % gegenüber der Gleitkomma-Baseline), Mehrknoten-Pipeline läuft, Backends AVX2+NEON. **Auf 7B +8,29 % nach Behebung zweier Implementierungsfehler (vorher +377 %); Kriterium noch nicht erreicht** — der einzige offene Punkt der Komponente. Durchsatz, [Modellkarte](INTEGER_LLM/artifacts/MODEL_CARD.md) und eine durchgespielte Erstinferenz-Anleitung liegen vor |
