...
|---|---|---|
| **L3 Agent Layer** | Agentische Workflows, Tool-Use, Session-Kontrakte | Session-Kontrakte wirken auf der Kette: Budget, Empfänger und Frist sind für den Agenten unveränderlich |
| **L2 Compute Layer** | Modell-Shards, Pods, Pipeline-Routing, Redundanz | **läuft**, bitgleich über 1 bis 24 Shards, Expertengemische eingeschlossen |
| **L1 Consensus Layer** | BFT, PoI-Aggregation, Staking, Slashing | **läuft**, alle vier Phasen abgeschlossen: BFT über fünf eigenständige Prozesse, verkettete Blöcke, unterschriebene Anweisungen |
...
| [TRAINING](TRAINING/README/README.md) | **Ganzzahliges Training trägt, und das ist gemessen.** **+0,67 %** gegenüber Gleitkomma, mit stochastischem Runden, **ganz ohne Gleitkommazustand**. Wachstum exakt funktionserhaltend, 0,00e+00. Für Expertengemische ebenso, mit Lastausgleich ohne Zufall |
