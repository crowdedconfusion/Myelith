...
Three weeks turned a planning phase in early August into **sixteen crates,
some 1,200 tests, and a running node.**
...
| Layer | Task | Status |
|---|---|---|
| **L3 Agent Layer** | Agentic workflows, tool use, session contracts | Design. Waiting on the layers below |
...
| [GOVERNANCE](GOVERNANCE/README/README.md) | **Parameters in one place, with rank.** 27 parameters with provenance and a mutability rank; the constitutional rank from Chap. 10.3 is enforced **technically**. Eight safety conditions are checked **on the proposal**, not after the vote. Crypto agility for the post-quantum migration is built in |
| [TRAINING](TRAINING/README/README.md) | **The one measurement is done: it holds.** Integer training at **+0.67 %** against floating point, with stochastic rounding. The training step needs **no floating-point state at all**. Growth is exactly function-preserving, deviation 0.00e+00 |
...
| [AGENT_LAYER](AGENT_LAYER/README/README.md) | Planning phase, waiting on the upstream layers |
