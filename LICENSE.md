Required Notice: Copyright (c) 2026 Joschka Benjamin Hänsler

# Myelith — Lizenz

**Lizenz:** [PolyForm Shield License 1.0.0](https://polyformproject.org/licenses/shield/1.0.0/)

## Einordnung (Erläuterung, nicht Teil der Lizenzbedingungen)

Diese Erläuterung dient dem Verständnis und ist **keine** verbindliche Änderung der unten stehenden, unveränderten PolyForm-Shield-Lizenzbedingungen. Im Streitfall gilt ausschließlich der Lizenztext selbst.

Myelith wird unter der PolyForm Shield License 1.0.0 veröffentlicht. Der Kerngedanke dieser Lizenz steht im Abschnitt „Noncompete": **jeder Zweck ist erlaubt, außer ein Produkt anzubieten, das mit der Software oder mit einem Produkt konkurriert, das der Lizenzgeber oder eines seiner verbundenen Unternehmen unter Verwendung der Software anbietet.**

Für Myelith bedeutet das im Kern:

- **Erlaubt, ausdrücklich auch kommerziell:** den Quellcode nutzen, verändern und einsetzen, um als Shard-Miner, Pod-Koordinator, Validator, Checker oder Gateway am kanonischen Myelith-Netzwerk teilzunehmen (Rollen wie im [Whitepaper](README/Whitepaper/myelith-whitepaper-v0.3.md), Kap. 3.3, definiert); Clients, Wallets, Dashboards oder andere Anwendungen zu bauen und zu betreiben, die mit dem kanonischen Myelith-Netzwerk interagieren; den Code zu verändern, zu erweitern und beizutragen.
