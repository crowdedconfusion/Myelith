...
| Größe | Wert |
|---|---|
| Modell | Qwen/Qwen3-8B (Basis-Variante) |
| FP-Baseline | BF16, HF-Implementierung: Perplexität 12.79 |
| Integer-Modell | θ_v 0.20.0 (Gewichte int8 per_channel, Aktivierungen int16 per_layer, LM-Head int16 per-channel als benannte spec-Ausnahme): Perplexität 13.27 |
| Datensatz | WikiText-2, Testsplit; 4 Sequenzen à 128 Tokens (435 ausgewertete Positionen) |
| Relativer Anstieg | **+3.75 %** |
...
2. **Kleine Modelle sind der ungünstigste Fall für Quantisierung.**
   Gemessen wurde hier ein Modell mit 8,2 Mrd. Parametern. Größere
