...
| Größe | Wert |
|---|---|
| Modell | Qwen/Qwen3-14B (Basis-Variante) |
| FP-Baseline | BF16, HF-Implementierung: Perplexität 11.41 |
| Integer-Modell | θ_v 0.18.0 (Gewichte int8 per_channel, Aktivierungen int16 per_layer, LM-Head int16 per-channel als benannte spec-Ausnahme): Perplexität 11.54 |
| Datensatz | WikiText-2, Testsplit; 4 Sequenzen à 128 Tokens (435 ausgewertete Positionen) |
| Relativer Anstieg | **+1.16 %** |
...
2. **Kleine Modelle sind der ungünstigste Fall für Quantisierung.**
   Gemessen wurde hier ein Modell mit 14,8 Mrd. Parametern. Größere
